...
typedef enum _QBASIPostFormat {
    QBASIMultipartFormDataPostFormat = 0,
    QBASIURLEncodedPostFormat = 1
...
@property(assign) QBASIPostFormat postFormat;
