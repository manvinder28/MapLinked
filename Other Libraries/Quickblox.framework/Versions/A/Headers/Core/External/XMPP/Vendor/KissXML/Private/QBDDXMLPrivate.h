...
/**
 * QBDDXMLNode can represent several underlying types, such as xmlNodePtr, xmlDocPtr, xmlAttrPtr, xmlNsPtr, etc.
...
@interface QBDDXMLNamespaceNode : QBDDXMLNode {
...
+ (id)nodeWithNsPrimitive:(xmlNsPtr)ns nsParent:(xmlNodePtr)parent owner:(QBDDXMLNode *)owner;

- (id)initWithNsPrimitive:(xmlNsPtr)ns nsParent:(xmlNodePtr)parent owner:(QBDDXMLNode *)owner;

- (xmlNodePtr)_nsParentPtr;

- (void)_setNsParentPtr:(xmlNodePtr)parentPtr;

// Overrides several methods in QBDDXMLNode
...
@interface QBDDXMLAttributeNode : QBDDXMLNode

+ (id)nodeWithAttrPrimitive:(xmlAttrPtr)attr owner:(QBDDXMLNode *)owner;

- (id)initWithAttrPrimitive:(xmlAttrPtr)attr owner:(QBDDXMLNode *)owner;
...
@interface QBDDXMLNode (PrivateAPI)

+ (id)nodeWithUnknownPrimitive:(xmlKindPtr)kindPtr owner:(QBDDXMLNode *)owner;

+ (id)nodeWithPrimitive:(xmlKindPtr)kindPtr owner:(QBDDXMLNode *)owner;

- (id)initWithPrimitive:(xmlKindPtr)kindPtr owner:(QBDDXMLNode *)owner;
...
BOOL DDXMLIsZombie(void *xmlPtr, QBDDXMLNode *wrapper);
...
@interface QBDDXMLElement (PrivateAPI)

+ (id)nodeWithElementPrimitive:(xmlNodePtr)node owner:(QBDDXMLNode *)owner;

- (id)initWithElementPrimitive:(xmlNodePtr)node owner:(QBDDXMLNode *)owner;

- (NSArray *)_elementsForName:(NSString *)name uri:(NSString *)URI;

- (QBDDXMLNode *)_recursiveResolveNamespaceForPrefix:(NSString *)prefix atNode:(xmlNodePtr)nodePtr;
...
@interface QBDDXMLDocument (PrivateAPI)

+ (id)nodeWithDocPrimitive:(xmlDocPtr)doc owner:(QBDDXMLNode *)owner;

- (id)initWithDocPrimitive:(xmlDocPtr)doc owner:(QBDDXMLNode *)owner;
