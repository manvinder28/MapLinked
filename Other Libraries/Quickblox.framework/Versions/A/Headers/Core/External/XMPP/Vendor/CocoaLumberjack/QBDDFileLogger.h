...
@protocol QBDDLogFileManager <NSObject>
@required
...
@interface QBDDLogFileManagerDefault : NSObject <QBDDLogFileManager> {
...
@interface QBDDLogFileFormatterDefault : NSObject <QBDDLogFormatter> {
...
@interface QBDDFileLogger : QBDDAbstractLogger <QBDDLogger> {
    id <QBDDLogFileManager> logFileManager;

    QBDDLogFileInfo *currentLogFileInfo;
...
- (id)initWithLogFileManager:(id <QBDDLogFileManager>)logFileManager;
...
@property(nonatomic, readonly) id <QBDDLogFileManager> logFileManager;
...
// Inherited from QBDDAbstractLogger
...
@interface QBDDLogFileInfo : NSObject {
    NSString *filePath;
    NSString *fileName;
...
- (NSComparisonResult)reverseCompareByCreationDate:(QBDDLogFileInfo *)another;

- (NSComparisonResult)reverseCompareByModificationDate:(QBDDLogFileInfo *)another;
