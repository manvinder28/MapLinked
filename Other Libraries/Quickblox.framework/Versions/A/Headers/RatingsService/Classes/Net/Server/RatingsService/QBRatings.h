...
+ (NSObject <Cancelable> *)createGameModeParameterValue:(QBRGameModeParameterValue *)gameModeParameterValue delegate:(NSObject <QBActionStatusDelegate> *)delegate context:(void *)context;
...
+ (NSObject <Cancelable> *)gameModeParameterValueWithID:(NSUInteger)gameModeParameterValueID delegate:(NSObject <QBActionStatusDelegate> *)delegate context:(void *)context;
...
+ (NSObject <Cancelable> *)updateGameModeParameterValue:(QBRGameModeParameterValue *)gameModeParameterValue delegate:(NSObject <QBActionStatusDelegate> *)delegate context:(void *)context;
